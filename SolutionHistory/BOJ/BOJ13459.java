...
public class Main {
    ...
    static void bt(int[][] currentBoard, int count, int currentDir, int rx, int ry, int bx, int by) {
//        debug(currentBoard);
        // 조기 종료 조건
        ...
        for (int dir = 0; dir < 4; dir ++) {
            ...
            bt(copied, count + 1, dir, rxrybxby[0], rxrybxby[1], rxrybxby[2], rxrybxby[3]);
            // 이동할 장소를 원래대로
...
//                    debug(tempArr);
    ...
    public static void main(String[] args) throws Exception {
        ...
        bt(board, 0, -1, rxrybxby[0], rxrybxby[1], rxrybxby[2], rxrybxby[3]);
